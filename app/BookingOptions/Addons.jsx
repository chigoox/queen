...
const Addons = ({ setIsOpened, contintue, opened, options, setBookingInfo, bookingInfo }) => {
    ...
    return (
        <>
            <Modal closeIcon={<IoIosCloseCircle size={24} color='black' />} open={isModalOpen} okButtonProps={{ hidden: true }} cancelButtonProps={{ hidden: true }}  className='p-0' onOk={handleOk} onCancel={handleCancel}>
