    ...
    return (
        <div className="mb-6">
            <button
                ...
                className="w-full text-left text-2xl font-bold text-gold-500 bg-black hover:bg-gray-900 py-2 px-4 rounded-md flex justify-between items-center"
            >
                {title}
...
const BookingInfo = () => (
    <div className="p-8 max-w-lg mx-auto bg-black rounded-lg shadow-lg text-white">
        ...
        <CollapsibleSection title="Rescheduling/Cancelation Policy">
            <ul className="space-y-4">
